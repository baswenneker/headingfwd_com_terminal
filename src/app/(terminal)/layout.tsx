...
/**
 * Layout for the terminal half of the site — the home page, the command deep
 * links (`/help`, `/about`, …) and the portfolio routes.
 *
 ...
 * terminal mounts underneath it) is scoped to these routes. The blog group
 * renders without it and therefore ships no terminal JavaScript at all.
 *
